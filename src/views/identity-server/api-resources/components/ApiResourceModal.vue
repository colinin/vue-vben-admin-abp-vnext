    ...
    >
      <Tabs v-model:activeKey="tabActivedKey" @change="handleChangeTab">
        ...
        <TabPane key="claim" :tab="t('AbpIdentityServer.UserClaim')">
          <ApiResourceClaim :target-claims="targetClaims" @change="handleClaimChange" />
        </TabPane>
            ...
            <Dropdown>
              ...
              <template #overlay>
                <Menu @click="handleClickMenu">
                  ...
                  <MenuItem key="api-resource-property">{{
...
<script lang="ts">
  ...
  import ApiResourceClaim from './ApiResourceClaim.vue';
  import ApiResourceScope from './ApiResourceScope.vue';
  import ApiResourceSecret from './ApiResourceSecret.vue';
  import ApiResourceProperty from './ApiResourceProperty.vue';
